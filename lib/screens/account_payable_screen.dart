...
class AccountPayableScreen extends StatefulWidget {
  const AccountPayableScreen({super.key});

  @override
  State<AccountPayableScreen> createState() => _AccountPayableScreenState();
}
...
class _AccountPayableScreenState extends State<AccountPayableScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.of(context).accountsPayable)),
