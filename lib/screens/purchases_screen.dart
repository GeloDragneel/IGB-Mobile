...
class _T {
  ...
  static const accent = Color(0xFF3B82F6); // Blue for Purchases
...
class _PurchasesScreenState extends State<PurchasesScreen>
  ...
  Future<List<PurchaseRecord>> _futureRecords = Future.value([]);
  ...
  Future<List<PurchaseRecord>> _fetchRecords() async {
    final auth = Provider.of<AuthProvider>(context, listen: false);
    final res = await http.get(
      Uri.parse(
        'https://igb-fems.com/LIVE/mobile_php/purchases.php'
  ...
  List<PurchaseRecord> get _pageRecords {
  ...
  Widget _buildCard(PurchaseRecord record, int index) {
                    ...
                    onSelected: (val) async {
                      if (val == 'view') {
                        ...
                        final pdfUrl =
                            ...
                            '?ID=${auth.userId}&file=${record.fileName}&folder=Vendor_Invoices';
...
class _ViewScreenState extends State<ViewScreen> {
  ...
  Future<void> _fetchInvoice() async {
    try {
      final res = await http.get(
        Uri.parse(
          'https://igb-fems.com/LIVE/mobile_php/purchases_info.php'
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [_T.accent.withOpacity(0.18), _T.card],
