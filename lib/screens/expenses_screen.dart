...
class _ExpensesScreenState extends State<ExpensesScreen> {
  ...
  Future<List<ExpenseRecord>> fetchExpenseRecords() async {
    ...
    final response = await http.get(
      Uri.parse(
        'https://igb-fems.com/LIVE/mobile_php/expenses.php?userId=${auth.userId}&from=${auth.fromDate}&to=${auth.toDate}',
      ),
    );
...
class _ViewScreenState extends State<ViewScreen> {
  ...
  Future<void> fetchInvoice() async {
    final url =
        'https://igb-fems.com/LIVE/mobile_php/expenses_info.php?InvoiceNo=${widget.invoiceNo}&UserID=${widget.userId}';
    try {
