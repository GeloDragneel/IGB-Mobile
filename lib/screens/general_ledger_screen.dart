...
class _GeneralLedgerScreenState extends State<GeneralLedgerScreen> {
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          final url =
              'https://igb-fems.com/LIVE/mobile_php/general_ledger.php?userId=${auth.userId}&from=$from&to=$to';
          try {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context).generalLedger),
        actions: [
                        ...
                        child: SingleChildScrollView(
                          child: DataTable(
                            ...
                            columns: [
                              ...
                              DataColumn(
                                label: Text(
                                  AppLocalizations.of(context).jrnl,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16,
                              ...
                              DataColumn(
                                label: Text(
                                  AppLocalizations.of(context).transDecription,
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16,
                            ...
                            rows: [
                              ..._trialBalanceData.map((item) {
                                final debit = NumberFormat('#,##0.00').format(
                                  double.tryParse(item['Debit'].toString()) ??
                                      0,
                                );
                                final credit = NumberFormat('#,##0.00').format(
