...
class ESubReportScreen extends StatefulWidget {
  const ESubReportScreen({super.key});

  @override
  State<ESubReportScreen> createState() => _ESubReportScreenState();
}

class _ESubReportScreenState extends State<ESubReportScreen> {
  DateTime? _dateFrom;
  DateTime? _dateTo;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(AppLocalizations.of(context).eSubReport)),
