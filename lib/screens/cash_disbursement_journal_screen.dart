...
class CashDisbursementJournalScreen extends StatefulWidget {
  ...
  @override
  State<CashDisbursementJournalScreen> createState() =>
      _CashDisbursementJournalScreenState();
}

class _CashDisbursementJournalScreenState
    extends State<CashDisbursementJournalScreen> {
  DateTime? _dateFrom;
  DateTime? _dateTo;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Cash Disbursement Journal')),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        final url =
                            'https://igb-fems.com/LIVE/mobile_php/cash_disbursement_journal.php?userId=${auth.userId}&from=$from&to=$to';
                        try {
