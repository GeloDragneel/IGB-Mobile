...
class _SalesScreenState extends State<SalesScreen> {
  ...
  Future<void> _performOCR(File imageFile) async {
    ...
    if (mounted) {
      ScannedTextDialog.show(context, scannedText, 'Scanned Sales Receipt');
    }
  }
  ...
  Future<List<SalesRecord>> fetchSalesRecords() async {
    ...
    final response = await http.get(
      Uri.parse(
        'https://igb-fems.com/LIVE/mobile_php/sales.php?userId=${auth.userId}',
      ),
    );
    ...
    setState(() {
      ...
      if (_searchQuery.isEmpty) {
        ...
        _filteredRecords = _allRecords.where((record) {
          return record.customerName.toLowerCase().contains(_searchQuery) ||
