    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          final url =
              'https://igb-fems.com/LIVE/mobile_php/expense_report.php?userId=${auth.userId}&from=$from&to=$to&branchType=${auth.branchType}&clientNum=${auth.clientNum}';
          try {
            ...
            if (response.statusCode == 200) {
              ...
              if (data['result'] == 'Success') {
                ...
                for (var item in invoices) {
                  ...
                  VATExempt +=
                      double.tryParse(item['VATExempt'].toString()) ?? 0;

                  ZeroRated +=
                      double.tryParse(item['ZeroRated'].toString()) ?? 0;
